...
class Message < ApplicationRecord
  ...
  # [:external_deleted] : Used to denote deletion outside Chat Arles while preserving the original content
  # [:external_created_at] : Can specify if the message was created at a different timestamp externally
  # [:external_error : Can specify if the message creation failed due to an error at external API
  # [:data] : Used for structured content types such as voice_call
  store :content_attributes, accessors: [:submitted_email, :items, :submitted_values, :email, :in_reply_to, :deleted, :external_deleted,
