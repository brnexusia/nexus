export const twilioTemplates = [
  ...
  {
    body: 'What type of Arles installation are you using? Select "Arles Cloud" if you are using app.chatwoot.com, otherwise select "Self-hosted Arles".',
    types: {
      'twilio/quick-reply': {
        body: 'What type of Arles installation are you using? Select "Arles Cloud" if you are using app.chatwoot.com, otherwise select "Self-hosted Arles".',
        actions: [
